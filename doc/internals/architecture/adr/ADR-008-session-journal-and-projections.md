...
⏳ **Приёмка живьём ещё не снята.** Нужен прогон, где остаток действительно есть, и его придётся
получать намеренно (промпт с командой в терминале без последующего `release`): модель иногда
освобождает терминалы сама (наблюдение 2026-08-11), и на таком прогоне освобождению нечего делать.
Ожидание: запись `turn_terminals_released` с `released>0` и `live`, вернувшимся в 0 на границе
turn'а.
