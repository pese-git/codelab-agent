...
**Живьём не подтверждено.** Воспроизведение: `mode=bypass` (пауз нет вовсе) и промпт, создающий
терминал с ожиданием; в логе ожидается `turn_finished cause=pipeline_closed`, а сразу за ней —
`turn_terminals_released cause=pipeline_closed released=N live=0`.
