...
- ⏳ **Живой прогон не проведён.** Ожидаемое наблюдение: `term_<pid>_<n>` в выводе инструментов,
  отсутствие `terminal_counter` в документе, отсутствие повторной выдачи одного alias'а.
