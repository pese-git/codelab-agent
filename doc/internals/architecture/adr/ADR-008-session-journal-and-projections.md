...
Осталось на часть 2: асинхронный шов освобождения остатка и политика отмены по признаку `waited`
(освобождать не раньше, чем исполнитель развернёт своё ожидание — окно наблюдалось живьём
2026-08-10). Приёмка требует прогона, где остаток действительно есть, и его придётся получать
намеренно: модель иногда освобождает терминалы сама (наблюдение 2026-08-11).
