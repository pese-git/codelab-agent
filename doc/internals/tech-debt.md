...
> Анализ логов живых прогонов (2026-07-29, ветка `ref/ADR-003-acp-independent-agent-core`): добавлены P2-36 (отказ policy не сообщает модели причину → каскад фантомных терминалов) и P2-37 (ошибки модели и штатные отмены на уровне `error`).
...
### 36. Отказ policy не сообщает модели причину → каскад фантомных терминалов — ⬜ ОТКРЫТО (обнаружено 2026-07-29, анализ логов)
...
### 37. Ошибки модели и штатные отмены логируются как `error` — ⬜ ОТКРЫТО (обнаружено 2026-07-29, анализ логов)
