...
### 61. Одновременных разрешений может быть несколько, а turn держит одно: второй вызов теряется навсегда — ⬜ ОТКРЫТО (обнаружено 2026-08-07, разбор логов; **приоритет P1**)
