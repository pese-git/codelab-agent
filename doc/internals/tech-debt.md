...
### 45. Слияние при конфликте ревизий дублирует историю: два ответа `role: tool` на один вызов — ⬜ ОТКРЫТО (обнаружено 2026-07-31, анализ логов)
...
### 46. `active_turn` не очищается по завершении turn'а → «orphaned permission request» при каждом перезапуске — ⬜ ОТКРЫТО (обнаружено 2026-07-31, анализ логов + покадровый снимок)
