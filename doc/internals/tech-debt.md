...
### 58. Мёртвые алиасы терминалов после рестарта: гарантированно провальные вызовы и реестр, который только растёт — 🟡 ЧАСТИЧНО (2026-08-04: владение закрыто, остаток свёрнут в расщепление ADR-007)
