...
**Остаток записи:** единственная дверь для перехода фазы. `TurnPhase` введён (ADR-008, шаг 2),
снятие turn'а получило владельца (шаг 5.2), но запись самой фазы всё ещё идёт из нескольких мест.
