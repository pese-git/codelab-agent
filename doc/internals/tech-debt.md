...
### 60. Текст ассистента попадает в историю дважды, когда модель вернула текст вместе с вызовами — ⬜ ОТКРЫТО (обнаружено 2026-08-06, разведка шага 3 ADR-008; **приоритет P1**)
