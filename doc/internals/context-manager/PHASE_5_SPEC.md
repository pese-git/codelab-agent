...
> 📋 **Статус: спецификация, НЕ реализовано** (на 2026-07-10). Рекурсивное разрешение зависимостей
> в коде отсутствует. Отслеживается в `openspec/changes/context-manager-implementation` (Фаза 5).
