...
> ⚠️ **SUPERSEDED.** Фаза 4 (инкрементальный режим) **не реализована** на 2026-07-16 —
> см. [INDEX канона](internals/context-manager/INDEX.md) (Phase 4 = `🔲 Готово к разработке`).
> Конфиг-ключ `agents.context.lifecycle.incremental` в текущем коде отсутствует.
> Документ сохранён для контекста будущей реализации. Канон: [PHASE_4_SPEC.md](internals/context-manager/PHASE_4_SPEC.md).
