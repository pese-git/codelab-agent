...
1. `doc/product/user-guide/llm/llm-providers.md` — описание и настройка
2. `doc/product/reference/llm-reference.md` — справочная информация
3. `doc/product/reference/environment.md` — переменные окружения
