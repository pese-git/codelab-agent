...
Если все команды выполнены успешно, вы готовы к [установке](installation.md).
...
- [Установка](installation.md) — пошаговая инструкция установки
- [Быстрый старт](quickstart.md) — первый запуск
