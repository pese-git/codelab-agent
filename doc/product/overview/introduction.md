...
- [Архитектура](architecture.md) — детальный обзор компонентов системы
- [Сценарии использования](use-cases.md) — примеры применения CodeLab
- [Установка](../getting-started/installation.md) — подробные инструкции по установке
