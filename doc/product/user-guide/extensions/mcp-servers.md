...
- [Инструменты](../basics/tools.md) — встроенные инструменты
- [Разрешения](../basics/permissions.md) — система разрешений
- [Конфигурация](../server/configuration.md) — настройка CodeLab
- [TOML конфигурация](../server/toml-configuration.md) — формат конфигурации
