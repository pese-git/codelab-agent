...
```mermaid
graph TD
    ENV["Переменные окружения<br/>Высший приоритет"]
    LOCAL[.env в проекте]
    GLOBAL[~/.codelab/config/.env]
    DEFAULTS["Значения по умолчанию<br/>Низший приоритет"]
...
> **Подробное руководство:** [TOML конфигурация](toml-configuration.md)
...
> **Подробное руководство:** [MCP серверы](../extensions/mcp-servers.md)

## См. также

- [TOML конфигурация](toml-configuration.md) — полное руководство по TOML
- [MCP серверы](../extensions/mcp-servers.md) — подключение и настройка MCP
- [Настройка сервера](server-setup.md) — параметры запуска
- [Разрешения](../basics/permissions.md) — политики безопасности
