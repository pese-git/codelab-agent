...
Все горячие клавиши из [TUI клиента](tui-client.md) работают в браузере:
...
- [TUI клиент](tui-client.md) — терминальный интерфейс
- [Настройка сервера](../server/server-setup.md) — параметры запуска
