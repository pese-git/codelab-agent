...
- [Настройка LLM провайдеров](../user-guide/11-llm-providers.md) — гайд по провайдерам
- [Fallback и устойчивость](../user-guide/12-fallback-resilience.md) — fallback цепочки
- [Конфигурация (справочник)](../reference/02-configuration.md) — все параметры
- [Переменные окружения](../reference/03-environment.md) — все CODELAB_* переменные
- [Добавление провайдера](../developer-guide/07-adding-providers.md) — developer guide
