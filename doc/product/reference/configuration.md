...
- [TOML конфигурация](../user-guide/server/toml-configuration.md) — полное руководство по TOML
- [MCP серверы](../user-guide/extensions/mcp-servers.md) — подключение и настройка MCP
- [Переменные окружения](environment.md) — детальное описание переменных
- [CLI команды](cli.md) — справочник командной строки
- [Настройка сервера](../user-guide/server/server-setup.md) — руководство по настройке
