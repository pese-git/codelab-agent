...
> **Deferred:** Атрибуты `token_slicing` будут добавлены при реализации
> OrchestratedStrategy и HierarchicalStrategy (см. MULTIAGENT_TECHNICAL_SPECIFICATION.md Блок 4).
...
> **Deferred:** Метрики `slicer_*` будут добавлены при реализации TokenSlicer
> (см. MULTIAGENT_TECHNICAL_SPECIFICATION.md Блок 4a).
...
> **Deferred:** TokenSlicing diff (до/после) будет добавлен при реализации TokenSlicer.
