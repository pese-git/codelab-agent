...
- `role: str` — роль агента по умолчанию (по умолчанию: "primary")
- `fallback_role: str` — fallback при недоступности стратегии (по умолчанию: "primary")
...
- `role: str` — "primary", "subagent", "orchestrator" (по умолчанию: "primary")
...
- `role`: "primary", "subagent", "orchestrator" (по умолчанию: "primary")
