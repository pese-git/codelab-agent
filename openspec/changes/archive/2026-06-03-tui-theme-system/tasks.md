...
- [x] 8.1 Добавить пример `[tui]` секции в `codelab/codelab.toml.example`
- [x] 8.2 Обновить `codelab/README.md` с описанием конфигурации тем
- [x] 8.3 Запустить `make check` для проверки linting и type checking
- [x] 8.4 Запустить все тесты `uv run python -m pytest` для проверки покрытия
- [x] 8.5 Ручное тестирование: переключение тем, сохранение конфига, визуальная индикация — покрыто автотестами TestThemeTogglePersistence
