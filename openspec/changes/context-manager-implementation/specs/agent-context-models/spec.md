...
Система MUST предоставлять `PayloadEnvelope` как frozen dataclass:
...
Система MUST предоставлять `TaskProfile` как frozen dataclass:
...
Система MUST предоставлять `BudgetAllocation` как frozen dataclass:
- `system_tokens: int`
- `history_tokens: int`
...
Система MUST предоставлять `BuildOptions` как frozen dataclass:
...
Система MUST предоставлять `ContextConfig` как frozen dataclass с feature flags:
...
Система MUST предоставлять `ContextItem` как frozen dataclass:
...
Система MUST предоставлять `ContextEpoch` как frozen dataclass:
- `epoch_id: str`
...
Система MUST предоставлять `ContextSnapshot` как frozen dataclass:
...
Система MUST предоставлять `ReconcileResult` как frozen dataclass:
...
Система MUST предоставлять `SubagentResult` как frozen dataclass:
