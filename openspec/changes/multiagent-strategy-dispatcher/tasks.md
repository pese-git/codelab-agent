...
- [ ] 1.2 Создать класс `StrategyDispatcher` с полями: _registry, _fallback
...
- [ ] 3.1 Обновить `codelab/src/codelab/server/protocol/state.py` — добавить _routing_mode в config_values
- [ ] 3.2 Обновить `handlers/config.py` — обработка set_config_option для _routing_mode
- [ ] 3.3 Написать тесты: set_config_option _routing_mode → сохраняется
