...
## 3. HybridContextManager
- [ ] 3.1 Создать `server/agent/core/context_manager.py` — HybridContextManager
- [ ] 3.2 Реализовать process_subagent_response() — child session + TokenSlicer
- [ ] 3.3 Реализовать ensure_context_fits() — делегирование ContextCompactor
- [ ] 3.4 Реализовать _create_child_session() — создание и связывание
- [ ] 3.5 Unit-тесты HybridContextManager
...
- [ ] 4.4 Интеграция с HybridContextManager
- [ ] 4.5 Реализовать max_steps предохранитель
- [ ] 4.6 Реализовать race condition guard (проверка available_agents)
- [ ] 4.7 Реализовать cancellation flow
- [ ] 4.8 Unit-тесты OrchestratedStrategy
...
- [ ] 9.3 Unit-тесты HybridContextManager
- [ ] 9.4 Unit-тесты OrchestratedStrategy
- [ ] 9.5 Integration тесты полного цикла
