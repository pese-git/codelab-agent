...
- [ ] 3.6 Реализовать `record_slicer(original_tokens, sliced_tokens, latency_ms, was_skipped)`
- [ ] 3.7 Реализовать `record_strategy_execution(strategy, total_time_ms)`
- [ ] 3.8 Реализовать `get_metrics(session_id) → SessionMetrics`
- [ ] 3.9 Реализовать подписку на AbstractEventBus для автосбора
- [ ] 3.10 Написать тесты: запись + получение метрик
- [ ] 3.11 Написать тесты: автозапись из событий EventBus
