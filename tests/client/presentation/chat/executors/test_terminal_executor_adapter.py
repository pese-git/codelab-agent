...
def mock_terminal_executor() -> MagicMock:
    ...
    executor.get_output = AsyncMock(return_value=("output text", True, 0))
...
class TestTerminalExecutorAdapter:
    ...
    async def test_get_output_with_error(
        ...
        mock_terminal_executor.get_output.return_value = ("error output", True, 1)
    ...
    async def test_wait_for_exit_with_none_exit_code(
        ...
        mock_terminal_executor.get_output.return_value = ("partial output", False, None)
