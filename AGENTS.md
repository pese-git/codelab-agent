...
- **Никогда не менять документацию в `doc/Agent Client Protocol/`, `doc/Agent To Agent Protocol/` и `doc/Model Context Protocol/`** — это официальные внешние протоколы.
- **Никогда не нарушать протоколы, описанные в `doc/Agent Client Protocol/`, `doc/Agent To Agent Protocol/` и `doc/Model Context Protocol/`** — все изменения в коде должны соответствовать спецификациям.
